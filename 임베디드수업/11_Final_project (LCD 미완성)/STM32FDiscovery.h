...
typedef volatile struct{ // according interrupt
...
#define I2C1 ((REG_I2C*)I2C1_BASE)

#define I2C1_CR1		(I2C1->rCR1)
#define I2C1_CR2		(I2C1->rCR2)
#define I2C1_OAR1		(I2C1->rOAR1)
#define I2C1_OAR2		(I2C1->rOAR2)
#define I2C1_DR		(I2C1->rDR)
#define I2C1_SR1		(I2C1->rSR1)
#define I2C1_SR2		(I2C1->rSR2)
#define I2C1_CCR		(I2C1->rCCR)
#define I2C1_TRISE		(I2C1->rTRISE)
